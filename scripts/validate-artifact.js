...
const checks = [
  ...
  ['artifact uses AIOM-native action language', html.includes('Action stack') && html.includes('Do this now') && html.includes('Why now') && html.includes('Use this') && html.includes('Capture back into Prism')],
