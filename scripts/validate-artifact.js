...
const checks = [
  ...
  ['artifact uses AIOM-native action language', html.includes('Action stack') && html.includes('Do this now') && html.includes('Why now') && html.includes('Use this') && html.includes('Update Account Memory')],
  ...
  ['overview keeps deeper context available progressively', html.indexOf('id="overviewFollowupPanel"') > -1 && html.indexOf('id="overviewFollowupPanel"') < html.indexOf('id="overviewSecondaryDetails"') && html.indexOf('id="overviewSecondaryDetails"') < html.indexOf('id="phaseBackbonePanel"') && html.includes('id="accountHealthOverlayPanel"') && html.includes('id="topWorkflowsPanel"') && html.includes('id="taskOwnershipPanel"')],
