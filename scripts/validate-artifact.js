...
const checks = [
  ...
  ['artifact uses AIOM-native action language', html.includes('Account Read') && html.includes('Recommended motion') && html.includes('Why now') && html.includes('Owner / date') && html.includes('Run recommended motion') && html.includes('Save Account Memory')],
  ...
  ['artifact simplifies overview for AIOM command center', html.includes('AIOM command center') && html.includes('id="overviewFollowupPanel"') && html.includes('id="overviewSecondaryDetails"') && html.includes('More operating context')],
  ['overview keeps deeper context available progressively', html.indexOf('id="overviewSecondaryDetails"') > -1 && html.indexOf('id="overviewSecondaryDetails"') < html.indexOf('id="accountEvidencePanel"') && html.indexOf('id="accountEvidencePanel"') < html.indexOf('id="phaseBackbonePanel"') && html.includes('id="overviewFollowupPanel"') && html.includes('id="accountHealthOverlayPanel"') && html.includes('id="topWorkflowsPanel"') && html.includes('id="taskOwnershipPanel"')],
  ...
  ['artifact includes task ownership split', html.includes('id="taskOwnershipPanel"') && html.includes('renderTaskOwnership(account)') && html.includes('task_ownership')],
  ...
  ['phase toolbar updates overview guidance', html.includes('function getActivePhaseKey(account)') && html.includes('renderPhaseBackbone(account, getActivePhaseKey(account))') && html.includes('renderAll();') && html.includes('Filtered overview to')],
  ...
  ['V1 data layer doc includes simplified overview rule', dataLayerDoc.includes('Overview Simplification Rule') && dataLayerDoc.includes('AIOM command center') && dataLayerDoc.includes('More operating context')],
